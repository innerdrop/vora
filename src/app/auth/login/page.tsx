    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="flex-1 flex flex-col justify-center px-8 lg:px-16 py-12">
                <Suspense fallback={<div className="flex justify-center"><div className="w-8 h-8 border-2 border-[#00F5D4] rounded-full animate-spin border-t-transparent"></div></div>}>
                    <LoginForm />
                </Suspense>
            </div>
